...
import 'auction_results_screen.dart';
...
class _CoSignProducerScreenState extends State<CoSignProducerScreen> with TickerProviderStateMixin {
  ...
  void _submitCoSign() {
    ...
    _showCoSignConfirmationModal();
  }

  void _showCoSignConfirmationModal() {
    showDialog(
      context: context,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        ...
                        // Navigate to auction results screen
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => AuctionResultsScreen(
                              title: widget.beatTitle,
                              status: 'Won',
                              timeAgo: '2 min ago',
                            ),
                          ),
                ...
                Text(
                  '@${widget.producerName} Profile Wall.',
                  style: GoogleFonts.getFont(
                    'Wix Madefor Display',
                    fontSize: 18.sp,
                    color: Colors.white,
